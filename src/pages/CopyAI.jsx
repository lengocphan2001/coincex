...
const CopyAI = () => {
  const [strategy, setStrategy] = useState('Chiến lược mặc định');
  const [capitalManagement, setCapitalManagement] = useState('0.1-0.2-0.4-0.8-1.6');
  const [currentProfit] = useState('314,87');
  const [stopLoss, setStopLoss] = useState('SL/TP');

  const transactions = [
    { time: '03:42 16/04/2023', bot: 'BOT AI', type: 'LONG', amount: '100', status: 'Chờ xử lý' },
    { time: '03:42 16/04/2023', bot: 'BOT AI', type: 'LONG', amount: '100', status: 'Hoàn tất', profit: '195' },
    { time: '03:42 16/04/2023', bot: 'BOT AI', type: 'LONG', amount: '100', status: 'Hoàn tất', profit: '-100' },
    { time: '03:42 16/04/2023', bot: 'BOT AI', type: 'LONG', amount: '100', status: 'Hoàn tất', profit: '195' },
    { time: '03:42 16/04/2023', bot: 'BOT AI', type: 'LONG', amount: '100', status: 'Hoàn tất', profit: '195' },
  ];
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="bg-[#0B1221] rounded-lg p-4">
                <h3 className="text-[#00D88A] text-xl font-bold">{currentProfit}$</h3>
              </div>
            </div>
